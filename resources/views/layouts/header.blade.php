<header class="p-3 bg-light bg-gradient">
    <div class="container-fluid">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start mx-lg-5">
            <a href="/" class="d-flex align-items-center mb-2 mb-lg-0 me-lg-2 text-dark text-decoration-none">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <li><a href="{{route('clients.index')}}" class="nav-link px-2 link-secondary text-dark">Clients</a></li>
                <li><a href="{{route('pos.index')}}" class="nav-link px-2 link-secondary text-dark">POs</a></li>
                <li><a href="{{route('invoices.index')}}" class="nav-link px-2 link-secondary text-dark">Invoices</a></li>
                <li><a href="{{route('payments.index')}}" class="nav-link px-2 link-secondary text-dark">Payments</a></li>
            </ul>
            ...
            <div class="dropdown text-end">
                <a href="#" class="d-block link-secondary text-dark text-decoration-none dropdown-toggle"
